function Set-AMServiceCondition {
    <#
        ...
        .LINK
            https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMServiceCondition.md
    #>
    ...
    PROCESS {
        foreach ($obj in $InputObject) {
            if ($obj.Type -eq "Condition" -and $obj.TriggerType -eq [AMTriggerType]::Service) {
