...
New-AMPermission [-InputObject] <Object> [[-Principal] <Object>] [-FullControl] [-Create] [-Read] [-Edit]
 ...
 [-ChangeSecurity] [-CanEdit] [-ManualResume] [-ManualRunFromHere] [-ToggleLock] [-UpdateRevision] [-Upgrade]
 [<CommonParameters>]
```
...
{{Fill DeleteRevisionFromRecycleBin Description}}
...
### -DeleteRevision
{{Fill DeleteRevision Description}}
...
{{Fill RestoreRevisionFromRecycleBin Description}}
...
### -RestoreRevision
{{Fill RestoreRevision Description}}
...
### -ChangeSecurity
{{Fill ChangeSecurity Description}}
...
### -ManualRunFromHere
{{Fill ManualRunFromHere Description}}
...
### -UpdateRevision
{{Fill UpdateRevision Description}}
