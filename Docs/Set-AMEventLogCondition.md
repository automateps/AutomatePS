...
online version: https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMEventLogCondition.md
schema: 2.0.0
---
...
```
Set-AMEventLogCondition [-InputObject] <Object> [[-LogType] <String>] [[-EventSource] <String>]
...
[https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMEventLogCondition.md](https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMEventLogCondition.md)
