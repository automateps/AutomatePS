...
online version: https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMServiceCondition.md
schema: 2.0.0
---
...
```
Set-AMServiceCondition [-InputObject] <Object> [[-ServiceName] <String>] [[-Action] <AMServiceTriggerState>]
...
[https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMServiceCondition.md](https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMServiceCondition.md)
