...
online version: https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMDatabaseCondition.md
schema: 2.0.0
---
...
```
Set-AMDatabaseCondition [-InputObject] <Object> [[-DatabaseType] <AMDatabaseTriggerType>] [[-Server] <String>]
 [[-NotificationPort] <Int32>] [[-Database] <String>] [[-Table] <String>] [[-UserName] <String>] [-Insert]
 [-Delete] [-Update] [-Drop] [-Alter] [-Wait] [[-Timeout] <Int32>] [[-TimeoutUnit] <AMTimeMeasure>]
...
[https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMDatabaseCondition.md](https://github.com/AutomatePS/AutomatePS/blob/master/Docs/Set-AMDatabaseCondition.md)
